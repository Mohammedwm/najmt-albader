...
<x-flash-error />
<form class="form d-flex flex-column flex-lg-row" action="{{ route('workers.update', $worker->id) }}" method="post"
            ...
            <div class="card-body text-center pt-0">
                ...
                <style>
                    .image-input-placeholder {
                        background-image: url({{$worker->image_path}});
                    }
            ...
            <div class="card-body pt-0">
                ...
                <select class="form-select mb-2 select2-hidden-accessible" data-control="select2"
                    ...
                    @foreach ($works as $item)
                        <option value="{{$item->id}}" @selected(old('work_id',$worker->work_id) == $item->id)>{{$item->name}}</option>
                    @endforeach
                </select>
                <!--end::Select2-->
                <!--begin::Description-->
                ...
                <div class="card-body pt-0">
                            ...
                            <div class="fv-row fv-plugins-icon-container">
                                <select id="country_id" class="form-select lh-1 py-3"
                                    ...
                                    <option value="{{$item->id}}" data-capital="{{$item->capital}}"
                                        @selected(old('country_id',$worker->country_id) == $item->id)>{{$item->name}}</option>
                                    @endforeach
                            ...
                            <div class="fv-row fv-plugins-icon-container">
                                <select class="form-select mb-2 select2-hidden-accessible" name="religion_id"
                                    ...
                                    @foreach ($religions as $religion)
                                        <option value="{{$religion->id}}" @selected(old('religion',$worker->religion_id) == $religion->id)>{{$religion->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <!--end::Col-->
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-9">
                            ...
                            <!--begin::Col-->
                            <div class="fv-row fv-plugins-icon-container">
                                <input class="form-control" id="kt_tagify_6" name="language" value="{{ old('language', $worker->language) }}"/>
                            </div>
                            <!--end::Col-->
                            <!--end::Row-->
                        </div>
                        ...
                        <div class="col-lg-9">
                            ...
                            <select class="form-select mb-2 select2-hidden-accessible" name="categories[]" multiple
                                ...
                                @foreach ($categories as $category)
                                    ...
                                    {{in_array($category->id,$selected_categories??[])?"selected":""}}>{{$category->name}}</option>
                                @endforeach
                            </select>
                            <!--end::Col-->
                            <!--end::Row-->
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-9">
                            ...
                            <!--begin::Col-->
                            <div class="fv-row fv-plugins-icon-container">
                                <input type="text" name="experiences" value="{{ old('experiences', $worker->experiences) }}"
