        ...
        <div class="card-header pt-7" id="kt_chat_contacts_header">
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                    <!--begin::Add customer-->
                    <a class="btn btn-primary" href="{{route('features.index')}}">
        ...
        <div class="card-body pt-5">
            ...
            <form action="{{ route('features.update', $feature->id) }}" method="post" enctype="multipart/form-data"
                ...
                <div class="fv-row mb-7 fv-plugins-icon-container">
                    ...
                    <!--begin::Input-->
                    <div class="mb-2">
                        <img id="thumbnail" src="{{ $feature->image_path }}" height="150">
                    </div>
                ...
                <div class="d-flex justify-content-start">
                    <!--begin::Button-->
                    <a href="{{ route('features.index') }}" class="btn btn-light me-3">إلغاء</a>
                    <!--end::Button-->
                    <!--begin::Button-->
