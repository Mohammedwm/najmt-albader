<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
        ...
        <a href="{{ route('dashboard.home') }}">
            <img alt="Logo" src="{{ asset('admin\assets\media\logos\test\Logo8.svg') }}" height="30px">
        </a>
        <!--end::Logo image-->
    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                <div class="menu-item">
                    <a class="menu-link @if(request()->is('dashboard*')) active @endif" href="{{ route('dashboard.home') }}">
                    <!--begin:Menu link-->
                ...
                <div class="menu-item">
                    <a class="menu-link @if(request()->is('works*')) active @endif" href="{{ route('works.index') }}">
                    <!--begin:Menu link-->
                        <span class="menu-link">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen022.svg-->
                ...
                <div class="menu-item">
                    <a class="menu-link @if(request()->is('workers*')) active @endif" href="{{ route('workers.index') }}">
                    <!--begin:Menu link-->
                        <span class="menu-link">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen022.svg-->
                ...
                <div class="menu-item">
                    <a class="menu-link @if(request()->is('bookings*')) active @endif" href="{{ route('bookings.index') }}">
                    <!--begin:Menu link-->
                        <span class="menu-link">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen022.svg-->
                ...
                <div class="menu-item">
                    <a class="menu-link @if(request()->is('features*')) active @endif" href="{{ route('features.index') }}">
                    <!--begin:Menu link-->
                        <span class="menu-link">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen022.svg-->
                            ...
                            <span class="menu-title">مميزات</span>
                        </span>
                    <!--end:Menu link-->
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link @if(request()->is('comments*')) active @endif" href="{{ route('comments.index') }}">
                    <!--begin:Menu link-->
                        <span class="menu-link">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen022.svg-->
                ...
                <div class="menu-item">
                    <a class="menu-link @if(request()->is('constants*')) active @endif" href="{{ route('constants.index') }}">
                    <!--begin:Menu link-->
                        <span class="menu-link">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen022.svg-->
                ...
                <div class="menu-item">
                    <a class="menu-link @if(request()->is('account-settings*')) active @endif" href="{{ route('account_settings') }}">
                    <!--begin:Menu link-->
                        <span class="menu-link">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen022.svg-->
                            ...
                            <span class="menu-title">إعدادت الحساب</span>
                        </span>
                    <!--end:Menu link-->
                    </a>
                </div>
