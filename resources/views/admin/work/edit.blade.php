        ...
        <div class="card-header pt-7" id="kt_chat_contacts_header">
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                    <!--begin::Add customer-->
                    <a class="btn btn-primary" href="{{route('works.index')}}">
            ...
            <form action="{{ route('works.update', $work->id) }}" method="post"
                ...
                <div class="fv-row mb-7 fv-plugins-icon-container">
                    ...
                    <input type="text" class="form-control @error('description') is-invalid @enderror" name="description" id="description"
                        value="{{ old('description', $work->description) }}">
                    @error('description')
                    <p class="invalid-feedback">{{ $message }}</p>
                    @enderror
                    <!--end::Input-->
                ...
                <div class="d-flex justify-content-start">
                    <!--begin::Button-->
                    <a href="{{ route('works.index') }}" class="btn btn-light me-3">إلغاء</a>
                    <!--end::Button-->
                    <!--begin::Button-->
                    <button type="submit" data-kt-contacts-type="submit" class="btn btn-primary">
                        <span class="indicator-label">تعديل</span>
                        <span class="indicator-progress">انتظ قليلاً...
